...
{
    public static int BinaryFind<TSource, TKey>(this IList<TSource> collection
                                              , TKey item, Func<TSource, TKey> selector, Comparer<TKey> comparer = null)
    {
        return BinaryFind(collection, item, selector, comparer, 0, collection.Count);
    }

    private static int BinaryFind<TSource, TKey>(this IList<TSource> collection
